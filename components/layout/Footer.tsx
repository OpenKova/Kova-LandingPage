import { BUILT_BY, FOOTER_COLUMNS, SITE, SOCIALS } from "@/lib/constants";
...
export function Footer() {
  return (
    ...
    >
      <div className="mx-auto max-w-[1200px] px-6 py-10 md:px-7">
        <div className="flex flex-col gap-8 md:flex-row md:justify-between">
          <div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener"
              className="built-by group mt-3 inline-flex items-center gap-1.5"
              aria-label={`built by ${BUILT_BY.handle} on github`}
            >
              <span className="built-by-label">built by</span>
              <span className="built-by-name">@{BUILT_BY.handle}</span>
              <span className="built-by-cursor" aria-hidden />
            </a>
            <p className="mt-3 text-[11px]" style={{ color: "var(--oc-text-muted)", fontFamily: "var(--oc-font-mono)" }}>
