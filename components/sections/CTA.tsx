export function CTA() {
  const cards = [
    ...
    { kicker: "Documentation", title: "Learn the workflows.", desc: "Setup, models, bots, and routines.", href: "https://github.com/OpenKova/kova", cta: "Read docs" },
    { kicker: "Open Source", title: "Own your keys.", desc: "MIT licensed. Bring any provider. Forever.", href: "https://github.com/OpenKova/kova", cta: "Star on GitHub" },
    { kicker: "Community", title: "Join the builders.", desc: "Share skills, request features.", href: "https://x.com/getkova_ai", cta: "Follow" },
  ];
  return (
